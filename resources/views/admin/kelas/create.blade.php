                    ...
                    <form action="{{ route('admin.kelas.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nama_kelas" class="form-control" placeholder="Contoh: Foundation Class 1" required>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" class="form-control" rows="4" placeholder="Tuliskan ulasan mengenai kurikulum kelas ini..." required></textarea>
                        </div>

                        <div class="mb-4 bg-light p-3 border-radius-md">
                            <label class="form-label text-dark font-weight-bolder mb-2"><i class="fas fa-lock text-warning me-2"></i>Persyaratan Keamanan Mengikuti Kelas Ini</label>
                            ...
                            <small class="text-secondary mt-1 d-block text-xs">Pilih kelas di atas jika pendaftar (Member) diwajibkan menyelesaikannya terlebih dahulu secara berurutan. (Contoh: DMT butuh siswa lulus CTT).</small>
                        </div>
