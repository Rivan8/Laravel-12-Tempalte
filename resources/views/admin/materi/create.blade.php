...
@section('title', 'Tambah Video: ' . $kelas->nama_kelas)
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0">
                <div class="card-header pb-0 border-bottom bg-transparent">
                    ...
                    <h5 class="mb-3">Tambah Materi Baru: <span class="text-info">{{ $kelas->nama_kelas }}</span></h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.materi.store', $kelas->id) }}" method="POST">
                        ...
                        <div class="mb-3 p-3 bg-light border-radius-md border-start border-4 border-danger">
                            ...
                            <input type="url" name="video_url" class="form-control border-danger" placeholder="https://www.youtube.com/watch?v=XXXXXXX atau format Embed" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="pembicara" class="form-control" placeholder="Contoh: Ps. John Doe" value="{{ old('pembicara') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" class="form-control" rows="5" placeholder="Tuliskan tujuan pembelajaran dari sesi tayangan video ini..."></textarea>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn bg-gradient-info mb-0">
                                <i class="fas fa-upload me-2"></i>Publikasikan Video
                            </button>
                        </div>
                    </form>
                </div>
