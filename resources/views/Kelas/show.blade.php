                ...
                <div class="card shadow-lg">
                    <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
                        <a href="javascript:;" class="d-block">
                            ...
                            @else
                                <div class="w-100 bg-gradient-dark border-radius-lg d-flex align-items-center justify-content-center"
                                    style="height: 350px;">
                    ...
                    <div class="card-body pt-4">
                        <span
                            class="text-gradient text-primary text-uppercase text-xs font-weight-bold my-2">{{ $kelas->kategori }}</span>
                        ...
                        <ul class="list-group mb-4">
                            <li class="list-group-item border-0 ps-0 text-sm"><i class="fas fa-check text-success me-2"></i>
                                Pengenalan dasar yang komprehensif.</li>
                            <li class="list-group-item border-0 ps-0 text-sm"><i class="fas fa-check text-success me-2"></i>
                                Fondasi kerohanian yang mengakar.</li>
                            <li class="list-group-item border-0 ps-0 text-sm"><i class="fas fa-check text-success me-2"></i>
                                Langkah-langkah praktikal kehidupan rohani.</li>
                        </ul>
                    </div>
                </div>
            </div>
